      ...
      {slot1 && 
        <div className={styles['image-container--image']}> 
            <p className={styles['target-paragraph-1']}>
                <span>{slot1.word1}<br/></span>
                <span>{slot1.word2}<br/></span>
                <span>{slot1.word3}<br/></span>
            </p>
      ...
      {slot2 && 
        <div className={styles['image-container--image']}> 
            <p className={styles['target-paragraph-2']}>
                <span>{slot2.word1}<br/></span>
                <span>{slot2.word2}<br/></span>
                <span>{slot2.word3}<br/></span>
                <span>{slot2.word4}<br/></span>
                <span>{slot2.word5}<br/></span>
            </p>
      ...
      {slot3 && 
        <div className={styles['image-container--image']}> 
            <p className={styles['target-paragraph-3']}>
                <span>{slot3.word1}<br/></span>
                <span>{slot3.word2}</span>
                <span>{slot3.word3}<br/></span>
                <span>{slot3.word4}<br/></span>
                <span>{slot3.word5}<br/></span>
                <span>{slot3.word6}<br/></span>
            </p>
